(function () {
	...
	*/
	...
	console.log(text.replace(/(Manuel Marques de Sousa)/g, 'Hiwoshu Nashimiro'));
	...
	*/
	...
	console.log(text.replace(/(brasileiro)/g, 'são-joseense'));
	...
	*/
	...
	console.log(text.replace(/(O Centauro de Luvas)/g, function(r, f) {
	...
	*/
	console.log( '\nReplace de datas:' );
	function replaceDate(r, d, m, a) {
		return d + '/' + getMonthNumber(m) + '/' + a;
	}
